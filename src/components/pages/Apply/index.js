...
function Role(props) {
  ...
  let img = (
    <img className={props.right ? "right img" : "img"} src={props.img} alt="" />
  );
  if (props.right) {
    return (
      <>
    ...
    <div className="apply">
      <div className="apply intro">
        <div className="inner">
          ...
          <p>
            Do you want to be part of a fast, dynamic and friendly team? Do you
            want to gain hands on development experience working for real
            clients? Do you want to get a glimpse of what development actually
            feels like? Are you someone that can understand what a client would
            want, and deliver exactly that? If you answered "Yes" to these
            questions, UTFO is definitely the right place for you. We will
            constantly increase the number and types of projects we do, taking
            on harder and bigger challenges in the process. Fill the application
            form at the bottom of this page, and come join us for all of this
            and beyond.
          </p>
        </div>
      </div>
      ...
      <div className="apply waved">
        ...
        <div className="roles inner">
          ...
          <Role name="Content Writers" img={ContentWriter}>
            The writers that bring out the best of the clients. They are in
            charge of the text that users see and out UTFO articles!
          </Role>
        </div>
        <div className="dash">-</div>
        <div className="join inner role">
          <h1>Become a Member!</h1>
          <p>
            Sign up through the form below to become a member of the University
            of Toronto Freelancers' Organization! Further join details will be
            sent to your email. Our main platform of communication is Discord,
            which you will be invited to upon completion of this form.
          </p>
          <br></br>
